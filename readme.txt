...
2. Admin DashBoard Options Control Panel.
3. Admin DashBoard Options Control Panel Help and FAQ
4. Enable or Disable Header and Footer Log.
5. Customization of all Plugin Options.
6. Manual Change the User Level Permissions.
7. Manual Change the Frequency of Checking.
8. Manual Change the Number of Checking Sessions.
9. Manual Change the Number of Failed Posts Fixed.
10. Manual Scheduling Plugin Checking and Fixing.
`
In the Future Version 2013/214 of this plugin, it will be introduced the New Admin DashBoard Options Control Panel to Optimize all of its Features!
...
1. Put directly `wp-missed-schedule.php` into /wp-content`/mu-plugins/`
2. Activation of WP Missed Schedule should be `AutomaTTic` since setup!
...
4. Activation of WP Missed Schedule should be `AutomaTTic` since setup!
...
3. √ Add Full Support for WP 3.6+ Coming Soon Release (2013.0131.3333)
4. √ Free Interference with others Scheduled Cron Jobs (2013.0131.3333)
5. √ Transparency of JetPack and others Publishing Plugins (2013.0131.3333)
6. √ Default WordPress Items Feed Syndication Support (2013.0131.3333)
7. √ Realtime Checking: 10 Future Posts for 1 Minute (2013.0131.3333)
8. √ Tiket #3712701 [TimeZone Issues](http://wordpress.org/support/topic/publishing-ahead-of-schedule-timezone-issues/) (2013.0131.3333)
9. √ Compatibility of Third Party Caching Plugins (2013.0131.3333)
10. √ Tiket #4163854 [W3 Total Cache Conflict](http://wordpress.org/support/topic/any-conflicts-with-w3-cache/) (2013.0131.3333)
11. √ Check Key Tag Authenticity (2013.0131.3333)
12. √ All in One Versions with vary Frequency of Check (2013.0531.4444)
13. √ Tiket #4218662 [HyperDB Query Compatibility](http://wordpress.org/support/topic/resolving-table_name-from-query-broken-in-select-query) (2013.0530.1840)
14. √ Preemptive Support WP 3.7+ ~ 3.8+ Future Releases (2013.0530.1840)

Future Version:

1. Check Plugin Authenticity Before Activation (2013.0000.2014-PRO)
2. Admin DashBoard Options Control Panel (2013.0000.2014-PRO)
3. Admin DashBoard Options Control Panel Help and FAQ (2013.0000.2014-PRO)
4. Enable or Disable Header and Footer Log (2013.0000.2014-PRO)
5. Customization of all Plugin Options (2013.0000.2014-PRO)
6. Manual Change User Level Permissions (2013.0000.2014-PRO)
7. Tiket #3740220 [Change Frequency](http://wordpress.org/support/topic/change-frequency/) (2013.0000.2014-PRO)
8. Manual Scheduling the Number of Checking Sessions (2013.0000.2014-PRO)
9. Manual Change the Number of Failed Posts Fixed (2013.0000.2014-PRO)
10. Manual Scheduling Plugin Checking and Fixing (2013.0000.2014-PRO)

= Development Release =
[Version 2013 Build 0530-BUGFIX.1840-DEVELOPMENTAL](http://downloads.wordpress.org/plugin/wp-missed-schedule.zip)
= Warning Notice =
`
WP Missed Schedule 2011.0920.2011 silently updated 2013-05-31.
WP Missed Schedule 2013.0130.2222 silently updated 2013-05-31.
WP Missed Schedule 2013.0131.3333 silently updated 2013-05-31.
...
If the version 2013.0531.4444 does not work well, please
downgrade to version 2013.0130.2222, the one immediately
preceding, or the one Major Stable 2011.0920.2011, for
example, as soon as possible! Remember that on Major
Stable Build is not included latest incremental changes.
...
on final Version number (2011.0920.*2011*) for example.

Incremental Build is identified with "progressive number"
on final Version number (2013.0531.*4444*) for example.
`
= Common Rules =
 ...
 * REMOVED <code>('WPMS_DELAY' ,1)</code>
 ...
 * UPDATE Check every 15 minutes <code>'WPMS_DELAY',15</code>
 * UPDATE Fix 10 items per session <code>'LIMIT' 10</code>
...
== Upgrade Notice ==
= 2013.0531.4444 =
Special Gold Update [STABLE] This Special Gold Build (wp-missed-schedule-gold.zip) include All in One Versions with vary Frequency of Checking ... ;) and is a 2013 Major Stable Candidate Release!
= 2013.0131.3333 =
Recommended Update [BUGFIX] Fixed Tikets: #3712701 TimeZone Issues - #4163854 W3 Total Cache Conflict - NEW Realtime Checking 10 Future Posts for 1 Minute for Default WordPress Items Feed Syndication Support - Free Interference with others Scheduled Cron Jobs at scale - Transparency of JetPack and others Publishing Plugins - More others issues solved: read changelog ... Yepa Yepa!
= 2013.0130.2222 =
...
Silent Update [STABLE] Try WP 3.5 Scheduled Posts Regression Ticket <a href="http://core.trac.wordpress.org/ticket/22944" title="WordPress 3.5 Scheduled Posts Regression Ticket #22944">#22944</a>
= 2012.0613.2012 =
Major Update [CERTIFIED] WP 2.6+ to 3.4+ Single and Network MultiSite Environment Update. Work under GPLv2 or later License.
= 2011.0920.2011 =
Major Update [CERTIFIED] WP 2.6+ to 3.3+ Single and Network MultiSite Environment Update. Work under GPLv2 or later License.
= 2011.0424.3333 =
